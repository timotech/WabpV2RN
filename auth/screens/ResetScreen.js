...
export default ResetScreen = (props) => {
  const [username, setUsername] = useState(props.navigation.getParam("email"));
  ...
  _register = async () => {
    ...
    fetch("https://books.timotech.com.ng/api/auth/resetpassword", {
      method: "POST",
      headers: {
          ...
          <View style={styles.scrollInner}>
            ...
            <View>
              ...
              <View style={styles.inputItem}>
                <TextInput
                  style={styles.textInput}
                  placeholder="Enter Verification Code Sent To Your Mail"
                  placeholderTextColor={Colors.titanWhite}
                  secureTextEntry
                  onChangeText={(cod) => setCode(cod)}
                  value={code}
                />
              </View>
            </View>
